    ...
    <nav class="flex-1 p-4">
            ...
            <ul class="space-y-1">
                ...
                <li>
                    <a href="pengajuan.php"
                        class="sidebar-link <?php echo ($current_page == 'pengajuan') ? 'active flex items-center px-4 py-3 rounded-xl text-white bg-primary-600' : 'flex items-center px-4 py-3 rounded-xl text-gray-700 hover:bg-primary-50'; ?>">
                        <i
                            class="fas fa-file-signature w-6 <?php echo ($current_page != 'pengajuan') ? 'text-gray-500' : ''; ?>"></i>
                        <span class="ml-3 font-medium">Pengajuan</span>
                    </a>
                </li>
                <li>
        ...
        <div class="mb-6">
            ...
            <ul class="space-y-1">
                <li>
                    <a href="profile.php"
                        class="sidebar-link <?php echo ($current_page == 'profile') ? 'active flex items-center px-4 py-3 rounded-xl text-white bg-primary-600' : 'flex items-center px-4 py-3 rounded-xl text-gray-700 hover:bg-primary-50'; ?>">
                        <i class="fas fa-user-cog w-6 <?php echo ($current_page != 'profile') ? 'text-gray-500' : ''; ?>"></i>
