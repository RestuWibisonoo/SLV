...
class Campaign
{
    ...
    public function delete($id)
    {
        ...
        // Hapus semua data terkait yang memiliki foreign key ke campaigns
        // Urutan: child tables dulu, baru parent table

        // 1. Hapus foto galeri penanaman (planting_gallery) yang terkait via plantings
