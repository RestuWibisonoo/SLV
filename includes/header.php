...
<body class="antialiased">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="hidden md:flex justify-between items-center h-20">
                ...
                <div class="flex items-center justify-center gap-1 flex-1">
                    ...
                    <div class="relative group" id="programsDropdown">
                        <a href="<?php echo $program_href; ?>" id="programsBtn"
                            class="<?php echo $is_program ? 'text-primary-700 font-semibold border-b-2 border-primary-600' : 'text-gray-600 hover:text-primary-600 font-medium transition'; ?> py-2 px-3 text-sm flex items-center cursor-pointer">
                            Program
                            <i class="fas fa-chevron-down ml-1.5 text-xs transition duration-300 group-hover:rotate-180" id="programsIcon"></i>
                        </a>
                        <!-- Invisible hover bridge -->
                        <div class="absolute left-0 w-full h-2"></div>
                        <div id="programsMenu"
                            class="absolute left-0 mt-2 w-64 bg-white rounded-xl shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 py-2 z-50 border border-gray-100">
                            <a href="<?php echo $program_href; ?>#corporation"
                            ...
                            <a href="<?php echo $program_href; ?>#collaboration"
                            ...
                            <a href="<?php echo $program_href; ?>#AjukanCampaign"
                                class="block px-4 py-3 hover:bg-primary-50 text-gray-700 hover:text-primary-600 transition">
                                <div class="font-semibold flex items-center text-sm">
                                    <i class="fas fa-paper-plane mr-3 text-primary-600 w-5 text-center"></i>Ajukan Campaign
                                </div>
                                <p class="text-xs text-gray-500 mt-1 ml-8">Program Pengajuan Campaign</p>
                            </a>
                        </div>
                    </div>
            ...
            <div id="mobileMenu"
                ...
                <div class="px-3 py-2 space-y-1">
                    ...
                    <!-- Mobile Programs -->
                    <div>
                        <div class="<?php echo $is_program ? 'bg-primary-50 text-primary-700 font-semibold' : 'text-gray-700 hover:text-primary-600'; ?> w-full rounded-lg transition flex items-center justify-between text-sm">
                            <a href="<?php echo $program_href; ?>" class="flex-1 px-3 py-2 flex items-center">
                                <i class="fas fa-leaf mr-2 w-4"></i><span class="align-middle">Program</span>
                            </a>
                            <button id="mobilePrograms" class="px-4 py-2 text-gray-500 hover:text-primary-600">
                        ...
                        <div id="mobileProgramsMenu" class="max-h-0 overflow-hidden transition-all duration-300 ease-in-out">
                            <div class="bg-gray-50 rounded-lg mx-2 my-1 overflow-hidden">
                                ...
                                <a href="<?php echo $program_href; ?>#sustainability"
                                    class="block px-3 py-1.5 text-gray-700 hover:bg-primary-100 hover:text-primary-700 transition border-l-2 border-transparent hover:border-primary-600 text-xs">
    ...
    <!-- Script untuk Menangani Mobile Menu -->
    <script>
        // Mobile Menu Handler
