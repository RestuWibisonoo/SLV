    ...
    <section class="py-20 bg-gray-50/50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4" data-aos="fade-up">
                <?php 
                if (!empty($planting_documentations)):
                    foreach ($planting_documentations as $doc):
                        // Tentukan URL gambar
                        $imgSrc = '';
                        if (!empty($doc['image'])) {
                ...
                ?>
                <a href="dokumentasi-detail.php?id=<?php echo $doc['id']; ?>" class="relative group overflow-hidden rounded-2xl aspect-square no-underline block transition hover:shadow-xl">
                    ...
                    <div class="absolute inset-0 bg-gradient-to-t from-black/70 via-black/30 to-transparent">
                        <div class="absolute bottom-4 left-4 text-white">
                            ...
                            <p class="text-xs text-gray-200 mt-1">
                                <i class="fas fa-map-marker-alt mr-1"></i><?php echo htmlspecialchars($doc['location']); ?>
                            </p>
                            <div class="flex gap-3 mt-2">
                                <span class="text-xs bg-green-500/80 px-2 py-1 rounded">
                                    <i class="fas fa-tree mr-1"></i><?php echo number_format($doc['trees_planted']); ?> pohon
                                </span>
                                <span class="text-xs bg-blue-500/80 px-2 py-1 rounded">
                                    <i class="fas fa-users mr-1"></i><?php echo $doc['volunteers']; ?> relawan
                                </span>
                            </div>
                        </div>
            ...
            <div class="text-center mt-8">
                <a href="dokumentasi.php" class="inline-flex items-center text-primary-700 font-semibold hover:text-primary-800 transition">
